...
%% load file
%%%imobolized GFP
file = '/tigress/LEIFER/PanNeuronal/2018/20180518/BrainScanner20180518_093125/';
% file = '/tigress/LEIFER/PanNeuronal/2017/20171128/BrainScanner20171128_154753/'; %%very immobalized
%BrainScanner20180518_091402
%BrainScanner20180518_094052
%%%moving GFP
...
for nrn = 1:size(GFP,1)  %iterate through cells
...
prs0 = [rho_m,lm,pm,sigr]'; % "true" params
...
corrected_iid = [corrected_iid; aa1'];
corrected_smooth = [corrected_smooth; aa3'];
corrected_gr = [corrected_gr; aa0'];
